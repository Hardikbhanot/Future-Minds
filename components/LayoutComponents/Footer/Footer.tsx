        ...
        <div className={styles.card_container}>
          ...
          <ul className={styles.links_list}>
            ...
            <ul className={styles.social_media_links_container}>
              <li>
                <Link href='https://www.linkedin.com/company/futuremindsofficial'>
                  <a
                    title='Linkedin link'
              ...
              <li>
                <Link href='https://twitter.com/futureminds15?s=21'>
                  <a
                    title='Twitter link'
              ...
              <li>
                <Link href='https://www.facebook.com/futureminds.in/'>
                  <a
                    title='Facebook link'
              ...
              <li>
                <Link href='https://www.instagram.com/futureminds__official/'>
                  <a
