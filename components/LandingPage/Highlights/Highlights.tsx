    ...
    <div className={styles.highlights_section}>
      ...
      <div className={styles.card_container}>
        <div className={styles.main}>
          <div className={styles.card}>
            <div className={styles.card_heading}>
              <p className={styles.card_percentage}>
                <strong>0%</strong>
              </p>
            ...
            <p className={styles.card_bottom_para}>
        ...
        <div className={cardbg}>
          <div className={styles.card}>
            <div className={styles.card_heading2}>
              <p className={styles.card_hundered}>
                <strong>100%</strong>
              </p>
              <p className={styles.card_text}>
                Refund
        ...
        <div className={styles.main}>
          <div className={styles.card}>
            <div className={styles.card_heading}>
              <p className={styles.card_refer}>
                <strong>Refer & Get Free Course </strong>
              </p>
            </div>
            <div className={styles.card_list}>
              <ul>
